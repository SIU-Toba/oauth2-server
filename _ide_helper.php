...
namespace {
    ...
    class Oauth2Server extends \SIUToba\Oauth2\Facades\Oauth2Server{
         ...
         * @static 
         */
        public static function getAuthorizeController(){
            return \OAuth2\Server::getAuthorizeController();
        }
         ...
         * @static 
         */
        public static function getTokenController(){
            return \OAuth2\Server::getTokenController();
        }
        ...
        public static function getResourceController(){
            return \OAuth2\Server::getResourceController();
        }
         ...
         * @static 
         */
        public static function getUserInfoController(){
            return \OAuth2\Server::getUserInfoController();
        }
         ...
         * @static 
         */
        public static function setAuthorizeController($authorizeController){
            return \OAuth2\Server::setAuthorizeController($authorizeController);
        }
         ...
         * @static 
         */
        public static function setTokenController($tokenController){
            return \OAuth2\Server::setTokenController($tokenController);
        }
         ...
         * @static 
         */
        public static function setResourceController($resourceController){
            return \OAuth2\Server::setResourceController($resourceController);
        }
         ...
         * @static 
         */
        public static function setUserInfoController($userInfoController){
            return \OAuth2\Server::setUserInfoController($userInfoController);
        }
         ...
         * @static 
         */
        public static function handleUserInfoRequest($request, $response = null){
            return \OAuth2\Server::handleUserInfoRequest($request, $response);
        }
         ...
         * @static 
         */
        public static function handleTokenRequest($request, $response = null){
            return \OAuth2\Server::handleTokenRequest($request, $response);
        }
         ...
         * @static 
         */
        public static function grantAccessToken($request, $response = null){
            return \OAuth2\Server::grantAccessToken($request, $response);
        }
         ...
         * appropriately.
         *
         * @param $request The request should have the follow parameters set in the querystring:
         ...
         * @param $user_id Identifier of user who authorized the client
         * @see http://tools.ietf.org/html/rfc6749#section-4
         * @ingroup oauth2_section_4
         * @static 
         */
        public static function handleAuthorizeRequest($request, $response, $is_authorized, $user_id = null){
            return \OAuth2\Server::handleAuthorizeRequest($request, $response, $is_authorized, $user_id);
        }
         ...
         *
         * @return \OAuth2\The authorization parameters so the authorization server can prompt
         ...
         * @static 
         */
        public static function validateAuthorizeRequest($request, $response = null){
            return \OAuth2\Server::validateAuthorizeRequest($request, $response);
        }
         ...
         * @static 
         */
        public static function verifyResourceRequest($request, $response = null, $scope = null){
            return \OAuth2\Server::verifyResourceRequest($request, $response, $scope);
        }
         ...
         * @static 
         */
        public static function getAccessTokenData($request, $response = null){
            return \OAuth2\Server::getAccessTokenData($request, $response);
        }
         ...
         * @static 
         */
        public static function addGrantType($grantType, $key = null){
            return \OAuth2\Server::addGrantType($grantType, $key);
        }
        
        /**
         * Set a storage object for the server
         *
         * @param $storage An object implementing one of the Storage interfaces
         * @param $key If null, the storage is set to the key of each storage interface it implements
         * @see storageMap
         * @static 
         */
        public static function addStorage($storage, $key = null){
            return \OAuth2\Server::addStorage($storage, $key);
        }
         ...
         * @static 
         */
        public static function addResponseType($responseType, $key = null){
            return \OAuth2\Server::addResponseType($responseType, $key);
        }
         ...
         * @static 
         */
        public static function getScopeUtil(){
            return \OAuth2\Server::getScopeUtil();
        }
         ...
         * @static 
         */
        public static function setScopeUtil($scopeUtil){
            return \OAuth2\Server::setScopeUtil($scopeUtil);
        }
        ...
        public static function getResponse(){
            return \OAuth2\Server::getResponse();
        }
        ...
        public static function getStorages(){
            return \OAuth2\Server::getStorages();
        }
        ...
        public static function getStorage($name){
            return \OAuth2\Server::getStorage($name);
        }
        ...
        public static function getGrantTypes(){
            return \OAuth2\Server::getGrantTypes();
        }
         ...
         * @static 
         */
        public static function getGrantType($name){
            return \OAuth2\Server::getGrantType($name);
        }
        ...
        public static function getResponseTypes(){
            return \OAuth2\Server::getResponseTypes();
        }
         ...
         * @static 
         */
        public static function getResponseType($name){
            return \OAuth2\Server::getResponseType($name);
        }
        ...
        public static function getTokenType(){
            return \OAuth2\Server::getTokenType();
        }
         ...
         * @static 
         */
        public static function getClientAssertionType(){
            return \OAuth2\Server::getClientAssertionType();
        }
        ...
        public static function setConfig($name, $value){
            return \OAuth2\Server::setConfig($name, $value);
        }
        ...
        public static function getConfig($name, $default = null){
            return \OAuth2\Server::getConfig($name, $default);
        }
